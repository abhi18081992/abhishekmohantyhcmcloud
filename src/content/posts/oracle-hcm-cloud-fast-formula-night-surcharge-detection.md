...
<!-- SVG FLOW DIAGRAM -->
<img src="/images/posts/oracle-hcm-cloud-fast-formula-night-surcharge-detection/diagram-1.png" alt="Diagram 1: Oracle HCM Cloud Fast Formula: Night Surcharge Detection in " style="max-width:100%;height:auto;margin:26px auto;display:block;border-radius:6px;border:1px solid #e5e0d8" loading="lazy" />
...
<!-- Plot area — SVG chart -->
<div>
<img src="/images/posts/oracle-hcm-cloud-fast-formula-night-surcharge-detection/diagram-2.png" alt="Diagram 2: Oracle HCM Cloud Fast Formula: Night Surcharge Detection in " style="max-width:100%;height:auto;margin:26px auto;display:block;border-radius:6px;border:1px solid #e5e0d8" loading="lazy" />
...
<!-- SVG chart -->
<div>
<img src="/images/posts/oracle-hcm-cloud-fast-formula-night-surcharge-detection/diagram-3.png" alt="Diagram 3: Oracle HCM Cloud Fast Formula: Night Surcharge Detection in " style="max-width:100%;height:auto;margin:26px auto;display:block;border-radius:6px;border:1px solid #e5e0d8" loading="lazy" />
