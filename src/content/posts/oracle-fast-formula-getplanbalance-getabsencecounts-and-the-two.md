...
<img src="/images/posts/oracle-fast-formula-getplanbalance-getabsencecounts-and-the-two/diagram-1.png" alt="Diagram 1: Oracle Fast Formula: GET_PLAN_BALANCE, GET_ABSENCE_COUNTS, a" style="max-width:100%;height:auto;margin:26px auto;display:block;border-radius:6px;border:1px solid #e5e0d8" loading="lazy" />
</div>
...
<div style="text-align:center;">
<img src="/images/posts/oracle-fast-formula-getplanbalance-getabsencecounts-and-the-two/diagram-2.png" alt="Diagram 2: Oracle Fast Formula: GET_PLAN_BALANCE, GET_ABSENCE_COUNTS, a" style="max-width:100%;height:auto;margin:26px auto;display:block;border-radius:6px;border:1px solid #e5e0d8" loading="lazy" />
</div>
...
<div style="text-align:center;">
<img src="/images/posts/oracle-fast-formula-getplanbalance-getabsencecounts-and-the-two/diagram-3.png" alt="Diagram 3: Oracle Fast Formula: GET_PLAN_BALANCE, GET_ABSENCE_COUNTS, a" style="max-width:100%;height:auto;margin:26px auto;display:block;border-radius:6px;border:1px solid #e5e0d8" loading="lazy" />
</div>
...
<div style="text-align:center;">
<img src="/images/posts/oracle-fast-formula-getplanbalance-getabsencecounts-and-the-two/diagram-4.png" alt="Diagram 4: Oracle Fast Formula: GET_PLAN_BALANCE, GET_ABSENCE_COUNTS, a" style="max-width:100%;height:auto;margin:26px auto;display:block;border-radius:6px;border:1px solid #e5e0d8" loading="lazy" />
</div>
...
<div style="text-align:center;">
<img src="/images/posts/oracle-fast-formula-getplanbalance-getabsencecounts-and-the-two/diagram-5.png" alt="Diagram 5: Oracle Fast Formula: GET_PLAN_BALANCE, GET_ABSENCE_COUNTS, a" style="max-width:100%;height:auto;margin:26px auto;display:block;border-radius:6px;border:1px solid #e5e0d8" loading="lazy" />
</div>
...
<div style="text-align:center;">
<img src="/images/posts/oracle-fast-formula-getplanbalance-getabsencecounts-and-the-two/diagram-6.png" alt="Diagram 6: Oracle Fast Formula: GET_PLAN_BALANCE, GET_ABSENCE_COUNTS, a" style="max-width:100%;height:auto;margin:26px auto;display:block;border-radius:6px;border:1px solid #e5e0d8" loading="lazy" />
</div>
...
<div style="text-align:center;">
<img src="/images/posts/oracle-fast-formula-getplanbalance-getabsencecounts-and-the-two/diagram-7.png" alt="Diagram 7: Oracle Fast Formula: GET_PLAN_BALANCE, GET_ABSENCE_COUNTS, a" style="max-width:100%;height:auto;margin:26px auto;display:block;border-radius:6px;border:1px solid #e5e0d8" loading="lazy" />
</div>
...
<div style="text-align:center;">
<img src="/images/posts/oracle-fast-formula-getplanbalance-getabsencecounts-and-the-two/diagram-8.png" alt="Diagram 8: Oracle Fast Formula: GET_PLAN_BALANCE, GET_ABSENCE_COUNTS, a" style="max-width:100%;height:auto;margin:26px auto;display:block;border-radius:6px;border:1px solid #e5e0d8" loading="lazy" />
</div>
...
<div style="text-align:center;">
<img src="/images/posts/oracle-fast-formula-getplanbalance-getabsencecounts-and-the-two/diagram-9.png" alt="Diagram 9: Oracle Fast Formula: GET_PLAN_BALANCE, GET_ABSENCE_COUNTS, a" style="max-width:100%;height:auto;margin:26px auto;display:block;border-radius:6px;border:1px solid #e5e0d8" loading="lazy" />
</div>
...
<div style="text-align:center;">
<img src="/images/posts/oracle-fast-formula-getplanbalance-getabsencecounts-and-the-two/diagram-10.png" alt="Diagram 10: Oracle Fast Formula: GET_PLAN_BALANCE, GET_ABSENCE_COUNTS, a" style="max-width:100%;height:auto;margin:26px auto;display:block;border-radius:6px;border:1px solid #e5e0d8" loading="lazy" />
</div>
...
<div style="text-align:center;">
<img src="/images/posts/oracle-fast-formula-getplanbalance-getabsencecounts-and-the-two/diagram-11.png" alt="Diagram 11: Oracle Fast Formula: GET_PLAN_BALANCE, GET_ABSENCE_COUNTS, a" style="max-width:100%;height:auto;margin:26px auto;display:block;border-radius:6px;border:1px solid #e5e0d8" loading="lazy" />
</div>
